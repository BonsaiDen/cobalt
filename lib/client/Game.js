...
// ----------------------------------------------------------------------------
function Game(gameIdent, gameVersion, playerClass, roomClass, networkInterface) {
...
util.inherit(Game, Emitter, {
    ...
    setNetworkInterface: function(networkInterface) {
        ...
        this._client = new Client(
            this._gameIdent, this._gameVersion,
            this._playerClass, this._roomClass,
