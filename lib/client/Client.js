...
Client.prototype = util.inherit(Emitter, {
    ...
    _onMessage: function(msg) {
        ...
        switch(action) {
            ...
            case Action.SERVER_MESSAGE_ROOM_COUNTDOWN_START:
                this._room.$startCountdown(data);
                break;

            case Action.SERVER_MESSAGE_ROOM_COUNTDOWN_UPDATE:
                this._room.$updateCountdown(data);
                break;

            case Action.SERVER_MESSAGE_ROOM_COUNTDOWN_END:
                this._room.$endCountdown(data);
                break;
